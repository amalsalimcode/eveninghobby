...
------------ | ------------- | ------------- | -------------
**last_update_time_stamp** | **str** | Provides the timestamp, in GMT, of when the resource was last updated. | [optional] 
**document_id** | **str** | System generated ID of the Control Document bound to Account Identifier (primaryAccountNumber/paymentToken) | [optional] 
...
**merchant_controls** | [**MerchantControls**](MerchantControls.md) |  | [optional] 
**global_controls** | [**GlobalControls**](GlobalControls.md) |  | [optional] 
