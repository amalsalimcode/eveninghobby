...
class TransactionControlsInner(object):
    """
    NOTE: This class is auto generated by the swagger code generator program.
    Do not edit the class manually.
    """
    def __init__(self, is_control_enabled=None, should_target_specific_card=None, time_range=None, should_alert_on_decline=None, alert_threshold=None, decline_threshold=None, user_information=None, spend_limit=None, control_type=None, user_identifier=None, should_decline_all=None, card_detail=None, filter_by_country=None):
        """
        TransactionControlsInner - a model defined in Swagger
    ...
    def is_control_enabled(self):
        """
        Gets the is_control_enabled of this TransactionControlsInner.
        ...
        :return: The is_control_enabled of this TransactionControlsInner.
        :rtype: bool
        """
    ...
    def is_control_enabled(self, is_control_enabled):
        """
        Sets the is_control_enabled of this TransactionControlsInner.
        If the indicator is set to true, the control type is considered active, if set to false the control type is not checked by the authorization engine

        :param is_control_enabled: The is_control_enabled of this TransactionControlsInner.
        :type: bool
        """
    ...
    def should_target_specific_card(self):
        """
        Gets the should_target_specific_card of this TransactionControlsInner.
        If the indicator is set to true, card details are required and card details will be used to locate a transaction control

        :return: The should_target_specific_card of this TransactionControlsInner.
        :rtype: bool
        """
    ...
    def should_target_specific_card(self, should_target_specific_card):
        """
        Sets the should_target_specific_card of this TransactionControlsInner.
        If the indicator is set to true, card details are required and card details will be used to locate a transaction control

        :param should_target_specific_card: The should_target_specific_card of this TransactionControlsInner.
        :type: bool
        """
    ...
    def time_range(self):
        """
        Gets the time_range of this TransactionControlsInner.

        :return: The time_range of this TransactionControlsInner.
        :rtype: TimeRange
        """
    ...
    def time_range(self, time_range):
        """
        Sets the time_range of this TransactionControlsInner.

        :param time_range: The time_range of this TransactionControlsInner.
        :type: TimeRange
        """
    ...
    def should_alert_on_decline(self):
        """
        Gets the should_alert_on_decline of this TransactionControlsInner.
        ...
        :return: The should_alert_on_decline of this TransactionControlsInner.
        :rtype: bool
        """
    ...
    def should_alert_on_decline(self, should_alert_on_decline):
        """
        Sets the should_alert_on_decline of this TransactionControlsInner.
        If true, VTC will trigger a decline notification for all transactions matching the associated control type. If false, no alerts will be sent for declined transactions related to this control type.

        :param should_alert_on_decline: The should_alert_on_decline of this TransactionControlsInner.
        :type: bool
        """
    ...
    def alert_threshold(self):
        """
        Gets the alert_threshold of this TransactionControlsInner.
        ...
        :return: The alert_threshold of this TransactionControlsInner.
        :rtype: float
        """
    ...
    def alert_threshold(self, alert_threshold):
        """
        Sets the alert_threshold of this TransactionControlsInner.
        Will trigger an alert for all approved transactions with amounts that equal or exceed the threshold setting for this control type. During authorization processing the cardholderBillAmount is used for comparision to identify if an alert should be sent.

        :param alert_threshold: The alert_threshold of this TransactionControlsInner.
        :type: float
        """
    ...
    def decline_threshold(self):
        """
        Gets the decline_threshold of this TransactionControlsInner.
        ...
        :return: The decline_threshold of this TransactionControlsInner.
        :rtype: float
        """
    ...
    def decline_threshold(self, decline_threshold):
        """
        Sets the decline_threshold of this TransactionControlsInner.
        Will trigger a decline for all transactions with amounts that equal or exceed this threshold for this control type. During authorization processing the cardholderBillAmount is then used for comparison to identify if a decline should be triggered.

        :param decline_threshold: The decline_threshold of this TransactionControlsInner.
        :type: float
        """
    ...
    def user_information(self):
        """
        Gets the user_information of this TransactionControlsInner.

        :return: The user_information of this TransactionControlsInner.
    ...
    def user_information(self, user_information):
        """
        Sets the user_information of this TransactionControlsInner.

        :param user_information: The user_information of this TransactionControlsInner.
    ...
    def spend_limit(self):
        """
        Gets the spend_limit of this TransactionControlsInner.

        :return: The spend_limit of this TransactionControlsInner.
        :rtype: SpendLimit
        """
    ...
    def spend_limit(self, spend_limit):
        """
        Sets the spend_limit of this TransactionControlsInner.

        :param spend_limit: The spend_limit of this TransactionControlsInner.
        :type: SpendLimit
        """
    ...
    def control_type(self):
        """
        Gets the control_type of this TransactionControlsInner.
        Indicates the specific type of the control for Transaction Controls valid values begin with: 'TCT_', for MerchantControls valid values begin with: 'MCT_'

        :return: The control_type of this TransactionControlsInner.
        :rtype: str
        """
    ...
    def control_type(self, control_type):
        """
        Sets the control_type of this TransactionControlsInner.
        Indicates the specific type of the control for Transaction Controls valid values begin with: 'TCT_', for MerchantControls valid values begin with: 'MCT_'

        :param control_type: The control_type of this TransactionControlsInner.
        :type: str
        """
    ...
    def user_identifier(self):
        """
        Gets the user_identifier of this TransactionControlsInner.
        ...
        :return: The user_identifier of this TransactionControlsInner.
        :rtype: str
        """
    ...
    def user_identifier(self, user_identifier):
        """
        Sets the user_identifier of this TransactionControlsInner.
        Uniquely identifies the cardholder who is to receive the alert message. The notification Service Provider should use this value to identify an individual and their contact preferences.  The userIdentifier should be a GUID, but at minimum must be unique per enrolling application. It is mandatory for VTC notifications. Maximum of 72 characters

        :param user_identifier: The user_identifier of this TransactionControlsInner.
        :type: str
        """
    ...
    def should_decline_all(self):
        """
        Gets the should_decline_all of this TransactionControlsInner.
        ...
        :return: The should_decline_all of this TransactionControlsInner.
        :rtype: bool
        """
    ...
    def should_decline_all(self, should_decline_all):
        """
        Sets the should_decline_all of this TransactionControlsInner.
        If the indicator is set to true, all qualifying transactions for this control type will receive a decline recommendation. If set to false, other attributes like declineThreshold will be checked.

        :param should_decline_all: The should_decline_all of this TransactionControlsInner.
        :type: bool
        """
    ...
    def card_detail(self):
        """
        Gets the card_detail of this TransactionControlsInner.

        :return: The card_detail of this TransactionControlsInner.
        :rtype: CardDetail
        """
    ...
    def card_detail(self, card_detail):
        """
        Sets the card_detail of this TransactionControlsInner.

        :param card_detail: The card_detail of this TransactionControlsInner.
        :type: CardDetail
        """
    ...
    def filter_by_country(self):
        """
        Gets the filter_by_country of this TransactionControlsInner.

        :return: The filter_by_country of this TransactionControlsInner.
    ...
    def filter_by_country(self, filter_by_country):
        """
        Sets the filter_by_country of this TransactionControlsInner.

        :param filter_by_country: The filter_by_country of this TransactionControlsInner.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, TransactionControlsInner):
            return False
