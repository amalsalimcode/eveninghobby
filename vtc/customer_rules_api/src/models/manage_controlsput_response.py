...
class ManageControlsputResponse(object):
    """
    ...
    def __init__(self, processing_timein_ms=None, received_timestamp=None, resource=None):
        """
        ManageControlsputResponse - a model defined in Swagger
    ...
    def processing_timein_ms(self):
        """
        Gets the processing_timein_ms of this ManageControlsputResponse.
        The processing time in milliseconds

        :return: The processing_timein_ms of this ManageControlsputResponse.
        :rtype: int
        """
    ...
    def processing_timein_ms(self, processing_timein_ms):
        """
        Sets the processing_timein_ms of this ManageControlsputResponse.
        The processing time in milliseconds

        :param processing_timein_ms: The processing_timein_ms of this ManageControlsputResponse.
        :type: int
        """
    ...
    def received_timestamp(self):
        """
        Gets the received_timestamp of this ManageControlsputResponse.
        The time the request is received.  Value is in GMT time

        :return: The received_timestamp of this ManageControlsputResponse.
        :rtype: str
        """
    ...
    def received_timestamp(self, received_timestamp):
        """
        Sets the received_timestamp of this ManageControlsputResponse.
        The time the request is received.  Value is in GMT time

        :param received_timestamp: The received_timestamp of this ManageControlsputResponse.
        :type: str
        """
    ...
    def resource(self):
        """
        Gets the resource of this ManageControlsputResponse.

        :return: The resource of this ManageControlsputResponse.
        :rtype: Resource
        """
    ...
    def resource(self, resource):
        """
        Sets the resource of this ManageControlsputResponse.

        :param resource: The resource of this ManageControlsputResponse.
        :type: Resource
        """
        if resource is None:
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, ManageControlsputResponse):
            return False
