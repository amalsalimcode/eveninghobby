...
class Resource(object):
    ...
    def first_name(self):
        """
        Gets the first_name of this Resource.
        First name of the Card Holder, Maximum of 25 characters

        :return: The first_name of this Resource.
        :rtype: str
        """
    ...
    def first_name(self, first_name):
        """
        Sets the first_name of this Resource.
        First name of the Card Holder, Maximum of 25 characters

        :param first_name: The first_name of this Resource.
        :type: str
        """
    ...
    def preferred_language(self, preferred_language):
        """
        Sets the preferred_language of this Resource.
        Preferred Language for Last mile Alerts , Currently supported languages are 'en-us' (English US) and 'es-us'(Spanish US)

        :param preferred_language: The preferred_language of this Resource.
        :type: str
        """
    ...
    def last_name(self):
        """
        Gets the last_name of this Resource.
        Last name of the Card Holder, Maximum of 25 characters

        :return: The last_name of this Resource.
        :rtype: str
        """
    ...
    def last_name(self, last_name):
        """
        Sets the last_name of this Resource.
        Last name of the Card Holder, Maximum of 25 characters

        :param last_name: The last_name of this Resource.
        :type: str
        """
    ...
    def preferred_country_code(self):
        """
        Gets the preferred_country_code of this Resource.
        Three letter ISO ALPHA-3 Code, currently only 'USA' supported

        :return: The preferred_country_code of this Resource.
        :rtype: str
        """
    ...
    def preferred_country_code(self, preferred_country_code):
        """
        Sets the preferred_country_code of this Resource.
        Three letter ISO ALPHA-3 Code, currently only 'USA' supported

        :param preferred_country_code: The preferred_country_code of this Resource.
        :type: str
        """
    ...
    def is_profile_active(self):
        """
        Gets the is_profile_active of this Resource.
        ...
        :return: The is_profile_active of this Resource.
        :rtype: bool
        """
    ...
    def is_profile_active(self, is_profile_active):
        """
        Sets the is_profile_active of this Resource.
        This value determine if the given customer profile is Active or Inactive. If isProfileActive is set to false then last Mile alerts cannot be delivered for this Customer Profile.

        :param is_profile_active: The is_profile_active of this Resource.
        :type: bool
        """
    ...
    def alerts_preferences(self):
        """
        Gets the alerts_preferences of this Resource.

        :return: The alerts_preferences of this Resource.
    ...
    def alerts_preferences(self, alerts_preferences):
        """
        Sets the alerts_preferences of this Resource.

        :param alerts_preferences: The alerts_preferences of this Resource.
    ...
    def default_alerts_preferences(self):
        """
        Gets the default_alerts_preferences of this Resource.

        :return: The default_alerts_preferences of this Resource.
    ...
    def default_alerts_preferences(self, default_alerts_preferences):
        """
        Sets the default_alerts_preferences of this Resource.

        :param default_alerts_preferences: The default_alerts_preferences of this Resource.
