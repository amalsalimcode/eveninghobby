...
class CustomerAlertsProfilegetResponse(object):
    """
    ...
    def __init__(self, processing_timein_ms=None, received_timestamp=None, resource=None):
        """
        CustomerAlertsProfilegetResponse - a model defined in Swagger
    ...
    def processing_timein_ms(self):
        """
        Gets the processing_timein_ms of this CustomerAlertsProfilegetResponse.
        The processing time in milliseconds

        :return: The processing_timein_ms of this CustomerAlertsProfilegetResponse.
        :rtype: int
        """
    ...
    def processing_timein_ms(self, processing_timein_ms):
        """
        Sets the processing_timein_ms of this CustomerAlertsProfilegetResponse.
        The processing time in milliseconds

        :param processing_timein_ms: The processing_timein_ms of this CustomerAlertsProfilegetResponse.
        :type: int
        """
    ...
    def received_timestamp(self):
        """
        Gets the received_timestamp of this CustomerAlertsProfilegetResponse.
        The time the request is received.  Value is in GMT time

        :return: The received_timestamp of this CustomerAlertsProfilegetResponse.
        :rtype: str
        """
    ...
    def received_timestamp(self, received_timestamp):
        """
        Sets the received_timestamp of this CustomerAlertsProfilegetResponse.
        The time the request is received.  Value is in GMT time

        :param received_timestamp: The received_timestamp of this CustomerAlertsProfilegetResponse.
        :type: str
        """
    ...
    def resource(self):
        """
        Gets the resource of this CustomerAlertsProfilegetResponse.

        :return: The resource of this CustomerAlertsProfilegetResponse.
        :rtype: Resource
        """
    ...
    def resource(self, resource):
        """
        Sets the resource of this CustomerAlertsProfilegetResponse.

        :param resource: The resource of this CustomerAlertsProfilegetResponse.
        :type: Resource
        """
        if resource is None:
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, CustomerAlertsProfilegetResponse):
            return False
